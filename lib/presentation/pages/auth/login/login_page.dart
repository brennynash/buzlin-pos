                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomPasswords(
                            type: TrKeys.admin,
                            onTap: () {
                              login.text = AppConstants.demoSellerLogin2;
                              password.text = AppConstants.demoSellerPassword2;
                              notifier.setEmail(AppConstants.demoSellerLogin2);
                              notifier
                                  .setPassword(AppConstants.demoSellerPassword2);
                            },
                          ),
                          const Spacer(),
                        ],
