...
class EditServiceCategoryNotifier
    extends StateNotifier<EditServiceCategoryState> {
  final CategoriesRepository _catalogRepository;
  final GalleryRepositoryFacade _galleryRepository;

  EditServiceCategoryNotifier(this._catalogRepository, this._galleryRepository)
      : super(EditServiceCategoryState(
