...
class _$ServiceCategoriesStateImpl extends _ServiceCategoriesState {
  ...
  @override
  String toString() {
    return 'ServiceCategoriesState(isLoading: $isLoading, categories: $categories, isAllSelect: $isAllSelect, selectCategories: $selectCategories, selectParents: $selectParents, selectSubs: $selectSubs)';
  }
