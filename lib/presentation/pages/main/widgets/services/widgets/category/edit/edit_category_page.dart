...
class EditServiceCategoryPage extends ConsumerStatefulWidget {
  const EditServiceCategoryPage({super.key});

  @override
  ConsumerState<EditServiceCategoryPage> createState() =>
      _EditServiceCategoryPageState();
}

class _EditServiceCategoryPageState
    extends ConsumerState<EditServiceCategoryPage> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Row(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Expanded(flex: 2, child: EditCategoryLeft()),
                                  Expanded(flex: 1, child: EditCategoryRight())
                                ],
                              ),
                              24.verticalSpace,
                              CustomButton(
