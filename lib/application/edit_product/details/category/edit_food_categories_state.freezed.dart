...
class _$EditFoodCategoriesStateImpl extends _EditFoodCategoriesState {
  ...
  @override
  String toString() {
    return 'EditFoodCategoriesState(isLoading: $isLoading, categories: $categories, categoryController: $categoryController, selectCategory: $selectCategory, oldCategory: $oldCategory, selectCategories: $selectCategories, categoryControllers: $categoryControllers)';
  }
