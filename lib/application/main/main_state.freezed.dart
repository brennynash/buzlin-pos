...
class _$MainStateImpl extends _MainState {
  ...
  @override
  String toString() {
    return 'MainState(isProductsLoading: $isProductsLoading, isMoreProductsLoading: $isMoreProductsLoading, isShopsLoading: $isShopsLoading, isBrandsLoading: $isBrandsLoading, isCategoriesLoading: $isCategoriesLoading, hasMore: $hasMore, active: $active, selectIndex: $selectIndex, products: $products, shops: $shops, categories: $categories, brands: $brands, dropDownShops: $dropDownShops, dropDownCategories: $dropDownCategories, dropDownBrands: $dropDownBrands, query: $query, shopQuery: $shopQuery, categoryQuery: $categoryQuery, brandQuery: $brandQuery, selectedShop: $selectedShop, selectedCategory: $selectedCategory, selectedBrand: $selectedBrand, selectedOrder: $selectedOrder, priceDate: $priceDate, shop: $shop)';
  }
...
abstract class _MainState extends MainState {
  const factory _MainState(
      ...
      final OrderData? selectedOrder,
      final PriceData? priceDate,
      final ShopData? shop}) = _$MainStateImpl;
